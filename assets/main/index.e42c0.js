  ...
  games: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      plateOpen: function plateOpen() {
        this.plateup.setPosition(this.plateup.x + 160, this.plateup.y + 5);
      },
      ...
      btnOdd: function btnOdd() {
        ...
        var locx = this.generateValues(-90, 90);
        var locy = this.generateValues(-120, 120);
      ...
      btnRed3All: function btnRed3All() {
        ...
        if (false == this.valuecoin6 && this.betValueCretedit >= 100) {
          AudioManager.instance.playCoinsInsert();
          var _locx = this.generateValues(-60, 60);
          var pos7 = this.generateValues(-120, 120);
